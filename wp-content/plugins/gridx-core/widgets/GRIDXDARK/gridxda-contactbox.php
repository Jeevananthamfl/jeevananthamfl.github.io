...
class Elementor_gridx_gridxdacontactbox_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section1',
            [
                'label' => esc_html__( 'Contact Box Section', 'gridx-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .info-box.about-contact-box h2 span'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'      => 
                    '{{WRAPPER}} .info-box.about-contact-box h2',
            ]
        );
...
<div data-aos="zoom-in" class="about-contact-box-wrap">
    ...
    <div class="about-contact-box info-box shadow-box">
        <a <?php if($gridxdacontactbox_output['boxlink']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
        class="overlay-link" href="<?php echo esc_url($gridxdacontactbox_output['boxlink']['url']); ?>"></a>
...
<?php endif; } ?>		
        ...
        <h2><?php echo ($gridxdacontactbox_output['heading']); ?></h2>
