...
class Elementor_gridx_gridxdaeducationbox_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section1',
            [
                'label' => esc_html__( 'Education Box Section', 'gridx-core' ),
        ...
        $this->add_control(
            'list1', //repeater name
            [
                'label'     => esc_html__( 'Education List', 'gridx-core' ),
...
<?php endif; } ?>
                <h4><?php echo esc_html($gridxdaeducationbox_output['title']); ?></h4>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <h3><?php echo esc_html($gridxdaeducationbox_loop['heading']); ?></h3>
